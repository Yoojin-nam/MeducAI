...
def list_gemini_models():
    try:
        ...
        print("❌ google-generativeai가 설치되어 있지 않습니다.  pip install -U google-generativeai")
        return
    ...
    print_header("✅ Google Gemini: 사용 가능한 모델 목록 (generateContent 지원 모델)")
    try:
        count = 0
        for m in genai.list_models():
            # Gemini 예제와 동일하게 generateContent 가능한 모델만 출력
