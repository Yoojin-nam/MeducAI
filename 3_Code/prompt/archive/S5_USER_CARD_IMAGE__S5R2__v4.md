# S5R2 — S5 S2 Card + Image Validation User Prompt v2.0 (Enhanced Difficulty + Radiology + Q2)

**Purpose:** Validate S2 Anki card AND its associated image for medical safety, exam fitness, educational quality, and radiology relevance.
...
### Section 1: Card Text Evaluation (Standard)
...
### Section 3: Difficulty Assessment (NEW)

**Note**: This section evaluates card text difficulty, not image difficulty. Since Q1 and Q2 images are placed on the BACK of cards, the image itself does not affect difficulty assessment.

9. **Difficulty problem detection**:
...
### Section 4: Radiology Relevance Assessment (NEW)

10. **Radiology relevance (영상의학과 적합성)**:
...
### Section 5: Q2 Cognitive Objective Verification (NEW)

11. **Q2 cognitive objective verification**:
...
**Changes in v2.0 (from v1.1):**
- Added Difficulty Assessment: Too Easy / Too Hard detection (Section 3)
- Added Radiology Relevance Assessment (Section 4)
- Added Q2 Cognitive Objective Verification: Diagnostic Overlap and Image Dependency (Section 5)
