...
3) Create ONE master table (Korean, Markdown).
   ...
   - Use clear, exam-oriented headers.ç
...
{
  "id": "{group_id}",
  "visual_type_category": "ONE of [Anatomy_Map, Pathology_Pattern, Pattern_Collection, Comparison, Algorithm, Classification, Sign_Collection, Physiology_Process, Equipment, QC, General]",
