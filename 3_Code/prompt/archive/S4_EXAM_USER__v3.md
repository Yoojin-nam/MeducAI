...
- The image must directly support answering the question: "{card_front_short}" with answer: "{card_answer_short}".
- Ensure the depicted findings are consistent with the explanation context: {card_back_keywords}.
