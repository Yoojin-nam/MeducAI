...
- **Clinical Nuance Specification**: When describing diagnostic criteria or imaging signs:
  ...
  - Example: "Feeding vessel" can appear in multiple conditions; emphasize the clinical context that helps differentiate (e.g., clinical history, age, associated findings).
