...
- Ensure signal intensity is relative to reference tissues (e.g., CSF should be dark on T1, bright on T2; fat should follow expected weighting).
...
- Incorporate physics-based artifacts if implied by the lesion (e.g., posterior shadowing for calcifications, acoustic enhancement for cysts).
