# S5R2 — S5 Validation System Prompt v2.0 (Clinical-blocking semantics + actionable signals)
...
- **Maximum 10 issues**: Report only the most important issues (highest severity first).
- **Concise descriptions**: Keep each description under 200 characters.
- **RAG evidence**: Include ONLY for blocking errors (max 3 entries).
