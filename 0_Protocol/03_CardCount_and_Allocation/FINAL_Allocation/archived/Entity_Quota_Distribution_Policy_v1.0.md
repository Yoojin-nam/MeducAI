...
**Status:** Archived (Frozen once FINAL generation begins)  
**Superseded by:** `0_Protocol/03_CardCount_and_Allocation/FINAL_Allocation/Entity_Quota_Distribution_Policy.md`
