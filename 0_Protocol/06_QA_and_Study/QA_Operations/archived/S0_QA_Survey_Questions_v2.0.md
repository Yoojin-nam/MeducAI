...
**Superseded by:** `0_Protocol/06_QA_and_Study/QA_Operations/S0_QA_Survey_Questions.md`
...
> **평가 대상:** Master Table 및 Infographic  
> **시간 상한:** Set당 약 90초–2분  
> **원칙:** Yes일 때만 1줄 근거 작성. No면 코멘트 작성하지 않음.

### C1. Critical Error (치명 오류)

**질문:** 테이블 또는 인포그래픽에 **치명 오류**가 있는가?
...
**안내 문구:**
> Critical Error란: 테이블/인포그래픽에서 임상 판단이나 학습을 심각히 왜곡할 수 있는 사실 오류를 의미합니다.

---

### C2. Scope / Alignment Failure (스코프 불일치)

**질문:** 테이블 또는 인포그래픽이 **Group Path / objectives와 명백히 불일치**하는가?
