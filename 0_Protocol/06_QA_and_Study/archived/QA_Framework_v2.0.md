...
**Date:** 2025-12-15
**Status:** Archived (Final; to be Frozen after S1 PASS)
**Superseded by:** `0_Protocol/06_QA_and_Study/QA_Framework.md`
...
**Canonical Reference:** `0_Protocol/05_Pipeline_and_Execution/S1_QA_Design_Error_Rate_Validation_v2.0.md`
