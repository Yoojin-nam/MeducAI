[MeducAI] [이름] 교수님께 S0 QA 평가 자료 배포 및 평가 요청드립니다.


안녕하세요 [       ] 교수님,

바쁘신 일정 중에도 MeducAI S0 QA 평가에 도움을 주시기로 해주셔서 진심으로 감사드립니다.
본 메일은 **교수님께 배정된 S0 QA 평가 자료(PDF)와 설문 링크 그리고 Kick off meeting 일정**을 전달드리기 위한 안내입니다.

* 이번 S0 평가는 **최종 배포 모델 선정의 핵심 근거**가 됩니다.
* 교수님의 **[전문 분야/교육 경험/이전 도움]**을 고려할 때, **임상적 적합성/시험 적합성** 평가에 중요한 기준점이 될 것으로 기대합니다.
...
본 평가는 공저자 참여를 전제로 안내드리지만, **참여 여부 및 공저자 참여 지속 여부는 전적으로 교수님 판단**에 따릅니다.
...
## 3) 평가자 역할(교수님 역할: [Attending / Resident])
...
교수님께서 남겨주실 평가는 S0 단계의 **Safety Gate 및 모델 선택(Non-inferiority 판단)**에 직접 반영되며,
