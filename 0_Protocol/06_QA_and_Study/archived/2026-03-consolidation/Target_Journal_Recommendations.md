# MeducAI 3-Paper 타겟 저널 추천

**Status:** Reference (Journal Selection Guide)  
**Version:** 1.1  
**Date:** 2026-01-15  
**Purpose:** 각 Phase별 논문에 적합한 타겟 저널을 객관적으로 제시  
**Note:** Radiology 계열 저널 제외 (공동 교신저자 고려)
...
- **핵심 내용**: Multi-agent LLM 시스템의 QA 신뢰도 검증
- **Primary Outcome**: False Negative Rate < 0.3% (Safety validation)
- **데이터**: 1,350 Resident + 330 Specialist 평가
- **통계 방법**: Clopper-Pearson exact CI, Inter-rater reliability (ICC)
...
| 저널 | IF (2024 추정) | 특성 | 적합도 |
|------|---------------|------|--------|
| **Journal of Digital Imaging** | ~3.5 | 의료 영상 AI 검증 | ⭐⭐⭐⭐⭐ |
| **BMC Medical Informatics and Decision Making** | ~3.5 | 의료 정보학, 오픈 액세스 | ⭐⭐⭐⭐ |
| **Computerized Medical Imaging and Graphics** | ~5.5 | 의료 영상 시각화, AI 검증 | ⭐⭐⭐⭐ |
| **IEEE Transactions on Biomedical Engineering** | ~4.4 | 생체의공학, 의료 AI 검증 | ⭐⭐⭐ |

#### Tier 3 (Broader Scope, Backup)
| 저널 | IF (2024 추정) | 특성 | 적합도 |
|------|---------------|------|--------|
| **PLOS ONE** | ~3.5 | 방법론 견고성 중시, 오픈 액세스 | ⭐⭐⭐ |
...
- **핵심 내용**: MLLM 생성 의료 교육 이미지의 임상적 정확성
- **Primary Outcome**: Illustration vs Realistic 비교, Inter-rater reliability
- **데이터**: Visual Modality Sub-study (330 paired items), Table Infographic (100 items)
- **통계 방법**: Paired comparison (Wilcoxon), ICC, Mixed-effects model
...
| 저널 | IF (2024 추정) | 특성 | 적합도 |
|------|---------------|------|--------|
| **Journal of Digital Imaging** | ~3.5 | 의료 영상 AI, 생성 모델 | ⭐⭐⭐⭐⭐ |
| **Computerized Medical Imaging and Graphics** | ~5.5 | 의료 영상 시각화, 생성 모델 | ⭐⭐⭐⭐ |
| **Journal of Medical Internet Research (JMIR)** | ~7.1 | 디지털 의료, 생성 AI 검증, 오픈 액세스 | ⭐⭐⭐⭐ |
| **BMC Medical Informatics and Decision Making** | ~3.5 | 의료 정보학, 오픈 액세스 | ⭐⭐⭐ |

#### Tier 3 (Broader Scope, Backup)
| 저널 | IF (2024 추정) | 특성 | 적합도 |
|------|---------------|------|--------|
| **PLOS ONE** | ~3.5 | 방법론 견고성, 오픈 액세스 | ⭐⭐⭐ |
| **Scientific Reports** | ~4.4 | Nature 계열, 넓은 범위 | ⭐⭐⭐ |
...
- **핵심 내용**: AI 생성 교육자료의 실제 교육 효과
- **Primary Outcomes**: 
  - Extraneous Cognitive Load (Leppink scale)
  - Learning Efficiency (time reduction)
  - Perceived Exam Readiness (change score)
  - Knowledge Retention (Likert)
- **데이터**: Baseline + FINAL 설문 (IRB 승인)
- **통계 방법**: Hierarchical testing, Linear regression, ANCOVA
...
### 투고 시기
- **목표**: 2026년 5-6월 투고
- **데이터 준비**: 2026년 4월 완료 예정 (시험 후 설문 수집)
...
3. **Impact Factor vs 적합도**
   - 적합도가 IF보다 중요
   - 의료 AI/디지털 의료 독자층이 타겟

4. **투고 시기 조정**
   - Paper 1, 2는 빠른 출판 가능
   - Paper 3는 시험 후 데이터 수집 필요
...
|---------|------|---------|
| 1.1 | 2026-01-15 | Radiology 계열 저널 제외 (공동 교신저자 고려), 대안 저널로 재구성 |
| 1.0 | 2026-01-15 | 초기 버전 생성 |

---

**Document Status**: Reference (Journal Selection Guide)  
