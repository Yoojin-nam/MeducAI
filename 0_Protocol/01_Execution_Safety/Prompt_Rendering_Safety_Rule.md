...
**Related Documents:**
- `prompt_authoring_guideline.md` - Prompt file authoring rules (complementary)
- `File_Replacement_Patch_Delivery_Rule.md` - Patch delivery workflow  
...
- Patch delivery workflow는 `File_Replacement_Patch_Delivery_Rule.md`를 참조한다.
